      ...
      <Transition appear show={navShow} as={Fragment} unmount={false}>
        <Dialog as="div" onClose={onToggleNav} unmount={false}>
          <Transition.Child
            ...
            unmount={false}
          >
            <div className="fixed inset-0 z-60 bg-black/25 dark:bg-white/25" />
          </Transition.Child>
          ...
          <Transition.Child
            ...
            unmount={false}
          >
            <Dialog.Panel className="fixed left-0 top-0 z-70 h-full w-full bg-white/30 backdrop-blur-md duration-300 dark:bg-gray-950/30">
              <nav
                ref={navRef}
