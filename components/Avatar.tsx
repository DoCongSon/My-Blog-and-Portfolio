...
const Avatar = () => {
  ...
  return (
    ...
    >
      <div
        style={style}
        className="max-h-[400px] select-none overflow-hidden rounded-md transition-all duration-200 ease-out"
      >
        <Image src={'/static/images/avatar.png'} alt="avatar" width={400} height={400} />
      </div>
    </div>
  )
}
